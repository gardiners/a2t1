...
We note small remaining discrepencies between the example plot and the reproduction at Figure \@ref(fig:reproduction). Most noteably, we have used a different population dataset from the example plot authors, and therefore the final mortality rate is slightly different for most countries. This is only particularly obvious for Ireland and Sweden, which have transposed their rankings in the reproduced plot.
