...
::: {.markbox data-latex=""}
A script for marking (`q2b.sh`) which prints the query and then executes it against the `world_x` database is available at https://github.com/gardiners/a2t1/blob/master/q2b.sh
:::
...
For the best experience, open the script in RStudio on your local machine and run each line, step-by-step, with Ctrl-Enter.
:::
